...
def divi(a,b):
   print ("~$",a/b)
#=================================================
def Bannr():                                                                                                  print ("\033[1;33m")
    print ("██████         █████   █████  ██")
    print ("██   ██       ██   ██ ██   ██ ██")
    print ("██████  █████ ██      ███████ ██")
    print ("██   ██       ██   ██ ██   ██ ██")                                                                print ("██   ██        █████  ██   ██ ███████")
    print ("\033[1;34m_____________________________________")
    print ("               Tool by-#####         ")                                                           print ("                         red hecker  ")
    print ("\033[1;34m_____________________________________")                                                 print ("\033[1;31m[1] \033[1;32m ADD      (+)")                                                           print ("\033[1;31m[2] \033[1;32m SUB      (-)")
